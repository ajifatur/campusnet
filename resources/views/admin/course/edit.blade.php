            ...
            <div class="card-body">
                <form method="post" action="{{ route('admin.course.update') }}" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-10 col-md-9">
                            <textarea name="description" class="form-control form-control-sm {{ $errors->has('description') ? 'border-danger' : '' }}" rows="5">{{ $course->description }}</textarea>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-10 col-md-9">
                            ...
                            <a href="{{ route('admin.course.index') }}" class="btn btn-sm btn-secondary"><i class="bi-arrow-left me-1"></i> Kembali</a>
                        </div>
                    </div>
                </form>
            </div>
